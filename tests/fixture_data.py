...
Wetterdaten altern schnell: Diese Dateien belegen die *Form* der Antwort und
einen datierten Ausschnitt ihres Inhalts. Zusicherungen leiten ihre Erwartungen
deshalb aus der Fixture ab, statt Zahlen hineinzuschreiben — eine feste
Temperatur waere beim naechsten Aufzeichnen falsch, ohne dass sich etwas
